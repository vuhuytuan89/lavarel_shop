...
<div class="span9">
    ...
    <li><a href="{{asset('/')}}">Sản Phẩm</a> <span class="divider">/</span></li>
    <li class="active">Chi tiết sản phẩm</li>
    </ul>
    <div class='row'>
        <div id="gallery" class="span3">
            <a href="<?php echo asset("uploads/{$sp->hinhanh}") ?>" title="{{{$sp->tensp}}}">
				<img src="<?php echo asset("uploads/{$sp->hinhanh}") ?>" style="width:100%" alt="{{{$sp->tensp}}}"/>
            </a>
    </div>
        ...
        <div class="span6">
				...
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span>{{number_format($sp->gia)}}</span></label>
					<div class="controls">
					
					  <a href="<?php echo asset("users/them-giohang/{$sp->id}"); ?>" class="btn btn-large btn-primary pull-right"> Mua <i class=" icon-shopping-cart"></i></a>
					</div>
				  </div>
				</form>
				...
				<hr class="soft clr"/>
				<p>
                                    <?php echo substr($sp->chitietsp, 0, 40)."..."; ?>
				</p>
